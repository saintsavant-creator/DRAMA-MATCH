/**
 * Merge Batch Z (mixed genres) into kdramas.js
 * 6 titles: My Mister, When the Stars Gossip, The Trunk,
 *           Our Blues, Flex x Cop, Agency
 * Added: 2026-04-12
 */
const fs = require('fs');
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-z-mixed.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-z-mixed.js');
...
const batchComment = `  // ===================================================================
  // BATCH Z — MIXED GENRES EXPANSION — 2026-04-12
  // Quiet Drama, Space Romance, Contract Marriage Thriller,
  // Ensemble Coastal Romance, Buddy-Cop Comedy, Corporate Power Drama
  // ===================================================================`;
