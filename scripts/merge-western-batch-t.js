/**
 * Merge western-batch-t.js into western-shows.js
 * 5 titles: Only Murders in the Building, The White Lotus,
 *           Severance, The Last of Us, Ripley
 * Added: 2026-04-12
 */
const fs = require('fs');
...
const batchPath = path.join(__dirname, '../data/western-batch-t.js');

const existing = require('../data/western-shows');
const batchEntries = require('../data/western-batch-t');
