/**
 * Merge batch P (Viki popular titles) into kdramas.js
 * 22 net-new titles: user-requested titles + popular Viki catalog shows
 * Includes Study Group, My Dearest Nemesis + 20 more
 */
const fs = require('fs');
const path = require('path');

const kdramasPath = path.join(__dirname, '../data/kdramas.js');
const batchPath = path.join(__dirname, '../data/kdramas-batch-p-viki.js');

const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-p-viki.js');
