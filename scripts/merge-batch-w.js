/**
 * Merge Batch W (mixed genres) into kdramas.js
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-w-mixed.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-w-mixed.js');
...
const batchComment = `  // ===================================================================
  // BATCH W — MIXED GENRES EXPANSION — 2026-03-24
  // Action/Thriller, Romantic Comedy, Melodrama, Historical, Supernatural, Slice-of-Life
  // ===================================================================`;
