/**
 * Merge Batch H (30 K-dramas) into kdramas.js
 * 30 titles: acclaimed thrillers, romances, fantasy, prestige titles (2019-2024)
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-h.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-h.js');
...
const batchComment = `  // ===================================================================
  // BATCH H — 30 ACCLAIMED K-DRAMAS EXPANSION — 2026-04-02
  // Thrillers, romance, fantasy, prestige titles from 2019-2024
  // ===================================================================`;
