/**
 * Merge Batch I (30 K-dramas) into kdramas.js
 * 30 titles: mix of classics and recent hits
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-i.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-i.js');
...
const batchComment = `  // ===================================================================
  // BATCH I — 30 POPULAR K-DRAMAS EXPANSION — 2026-04-01
