/**
 * Merge Batch Q (mixed genres — classic to modern era) into kdramas.js
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-q-mixed.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-q-mixed.js');
...
const batchComment = `  // ===================================================================
  // BATCH Q — CLASSIC TO MODERN ERA (2009–2024) — 2026-03-24
  // Spy/Action, Rom-Com, Coming-of-Age, Historical, Sci-Fi, Melodrama, Thriller
  // ===================================================================`;
