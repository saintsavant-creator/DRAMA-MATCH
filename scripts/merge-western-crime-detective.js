/**
 * Merge western-batch-crime-detective.js into western-shows.js
 * 35 Western Crime/Detective Shows: NCIS franchise, Law & Order franchise,
 * CSI franchise, Bones, Blue Bloods, and classic procedurals.
 */
const fs = require('fs');
const path = require('path');

const westernPath = path.join(__dirname, '../data/western-shows.js');
const batchPath = path.join(__dirname, '../data/western-batch-crime-detective.js');

const existing = require('../data/western-shows');
const batchEntries = require('../data/western-batch-crime-detective');
