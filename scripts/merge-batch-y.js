/**
 * Merge Batch Y (mixed genres) into kdramas.js
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-y-mixed.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-y-mixed.js');
...
const batchComment = `  // ===================================================================
  // BATCH Y — MIXED GENRES EXPANSION — 2026-04-05
  // Psychological Thriller, Social Thriller, Corporate Drama,
  // Fantasy Philosophical, Horror Thriller, Political Romance, Crime Thriller
  // ===================================================================`;
