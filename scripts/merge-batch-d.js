/**
 * Merge Batch D (mixed genres) into kdramas.js
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-d-mixed.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-d-mixed.js');
...
const batchComment = `  // ===================================================================
  // BATCH D — MIXED GENRES EXPANSION — 2026-03-23
  // Action, Mystery/Thriller, Melodrama, Workplace, Family, Supernatural
  // ===================================================================`;
