/**
 * Merge Batch X (mixed genres) into kdramas.js
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-x-mixed.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-x-mixed.js');
...
const batchComment = `  // ===================================================================
  // BATCH X — MIXED GENRES EXPANSION — 2026-03-30
  // Medical Action, Survival Thriller, Social Satire, Historical Rom-Com,
  // Historical Political Romance, Sports Rom-Com
  // ===================================================================`;
