/**
 * Merge Batch M (mixed genres) into kdramas.js
...
const batchPath = path.join(__dirname, '../data/kdramas-batch-m-mixed.js');

// Load via require for validation
const existing = require('../data/kdramas.js');
const batchEntries = require('../data/kdramas-batch-m-mixed.js');
...
const batchComment = `  // ===================================================================
  // BATCH M — MIXED GENRES EXPANSION — 2026-03-25
  // Classic Romcom, Melodrama, Historical, Medical, Sci-Fi/Fantasy, Crime, Workplace
  // ===================================================================`;
